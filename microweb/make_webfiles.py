# -*- coding: UTF8 -*-
# Micropython web static files
# Author: Draco.Wang <1599980410@qq.com>

def create_jquery_js():
    with open("jquery-3.5.1.min.js", "w") as f:
        # 写入的时候必须加r，表明是原始格式，这样就不怕转义符了
        f.write(
            r"""
...
def create_jquery_ui():
    with open("jquery-ui.css", "w") as f:
        f.write(
            r"""
.ui-helper-hidden {
    display: none;
...
def create_jquery_ui_js():

    with open("jquery-ui.min.js", "w") as f:
        f.write(
                r"""    
...
_fileslist = uos.listdir()

if not 'jquery-3.5.1.min.js' in _fileslist:
    print('create jquery-3.5.1.min.js')
    create_jquery_js()
if not 'jquery-ui.css' in _fileslist:
    print('create jquery-ui.css')
    create_jquery_ui()
